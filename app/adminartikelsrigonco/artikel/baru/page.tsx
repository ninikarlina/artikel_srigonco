        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl md:text-3xl font-bold text-gray-900">Buat Artikel Baru</h1>
                <p className="text-sm md:text-base text-gray-600 mt-1">Tulis dan publikasikan artikel baru</p>
              </div>
            </div>
